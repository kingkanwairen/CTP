...
#ifdef _MD_DEBUG
		QString data = QString(tr("[Depth]  InstrumentId: ")) + QString(pDepthMarketData->InstrumentID) + QString(tr("  LastPrice: ")) + QString::number(pDepthMarketData->LastPrice) +
			QString(tr("  BidPrice: ")) + QString::number(pDepthMarketData->BidPrice1) + QString(tr("  BidVolume: ")) + QString::number(pDepthMarketData->BidVolume1) + QString(tr("  AskPrice: ")) +
			QString::number(pDepthMarketData->AskPrice1) + QString(tr("  AskVolume: ")) + QString::number(pDepthMarketData->AskVolume1) + QString(tr("  Volume: ")) +
			QString::number(pDepthMarketData->Volume, 'f', 0) +  QString(tr("  OpenInterest: ")) + QString::number(pDepthMarketData->OpenInterest, 'f', 0);
		USTPLogger::saveData(data);
#endif
