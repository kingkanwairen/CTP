...
#define MAIN_WINDOW_TILTE tr("交易所套利交易系统")
...
#define  STRATEGY_WIDGET_TAB_HEAD_17 tr("最劣价超价")
#define  STRATEGY_WIDGET_TAB_HEAD_18 tr("定时报单")
#define  STRATEGY_WIDGET_TAB_HEAD_19 tr("对价")
#define  STRATEGY_WIDGET_TAB_HEAD_20 tr("合约一定时撤单")
#define  STRATEGY_WIDGET_TAB_HEAD_21 tr("合约二定时撤单")
#define  STRATEGY_WIDGET_TAB_HEAD_22 tr("循环")
#define  STRATEGY_WIDGET_TAB_HEAD_23 tr("撤单参考Tick")
#define  STRATEGY_WIDGET_TAB_HEAD_24 tr("投机套保")
#define  STRATEGY_WIDGET_TAB_HEAD_25 tr("删除埋单")

#define  STRATEGYHEAD_LENGTH 26
#define  SAVE_ITEM_LENGTH 24
...
#define  DEPTH_WIDGET_TAB_HEAD_4 tr("买-卖量")
#define  DEPTH_WIDGET_TAB_HEAD_5 tr("卖-买价")
#define  DEPTH_WIDGET_TAB_HEAD_6 tr("卖-买量")
#define  DEPTH_WIDGET_TAB_HEAD_7 tr("买-买价")
#define  DEPTH_WIDGET_TAB_HEAD_8 tr("卖-卖价")
#define  DEPTH_WIDGET_TAB_HEAD_9 tr("买-买量")
...
#define  UNILATERAL_WIDGET_TAB_HEAD_0 tr("合约")
#define  UNILATERAL_WIDGET_TAB_HEAD_1 tr("买卖")
#define  UNILATERAL_WIDGET_TAB_HEAD_2 tr("开/平")
#define  UNILATERAL_WIDGET_TAB_HEAD_3 tr("委托价")
#define  UNILATERAL_WIDGET_TAB_HEAD_4 tr("数量")
#define  UNILATERAL_WIDGET_TAB_HEAD_5 tr("循环档")
#define  UNILATERAL_WIDGET_TAB_HEAD_6 tr("循环次数")
#define  UNILATERAL_WIDGET_TAB_HEAD_7 tr("提交")
#define  UNILATERAL_WIDGET_TAB_HEAD_8 tr("删除埋单")
#define  UNILATERAL_HEAD_LENGTH 9
#define  SAVE_UNILATERAL_LENGTH 7
...
#define VERSE_VALUE_ACCURACY -0.00001
...
#define CANCEL_DELAY_TIME 400
#define SUPER_PRICE_STALL 3
#define REFER_PRICE_NUM 1
