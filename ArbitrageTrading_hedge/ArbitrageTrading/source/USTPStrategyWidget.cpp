		...
		case 1:
			{
				...
				USTPStrategyBase* pStrategy = new USTPConditionArbitrage(label, firstIns, secIns, orderPriceTick, firstPriceSlipPoint, secPriceSlipPoint, qty, bs, 
					offset, hedge, cancelFirstTime, cancelSecTime, cycleStall, actionReferNum, actionSuperNum, worstSuperPrice, isAutoFirstCancel, isAutoSecCancel, isCycle, isOppentPrice,
