...
private:
	...
	QString mComplexKey;
	QString mFirstComplexIns;
	QString mSecComplexIns;

	QString mMainFirstInstrument;
	QString mMainSecInstrument;
	QString mSubFirstInstrument;
	QString mSubSecInstrument;

	
	double mMainFirstBidPrice;
	double mMainFirstAskPrice;
	double mMainSecBidPrice;
	double mMainSecAskPrice;

	double mSubFirstBidPrice;
	double mSubFirstAskPrice;
	double mSubSecBidPrice;
	double mSubSecAskPrice;
	...
	int mMainFirstBidQty;
	int mMainFirstAskQty;
	int mMainSecBidQty;
	int mMainSecAskQty;
