...
protected:
	...
	virtual void orderInsert(const int& reqId, const QString& insLabel, const QString& instrument, const double& orderPrice, const char& direction, const int& qty, const char& priceType,
...
private:
	double mWorstSuperPrice;
	double mFirstInsTradePrice;
};
...
public:
	...
	USTPUnilateralOrder(const QString& orderLabel, const QString& insName, const char& direction, const char& offsetFlag, 
...
signals:
	...
	void onUnilateralFinished(const QString& orderLabel, const QString& insName, const char& direction, const char& offsetFlag, 
