...
public:
	USTPMdDialog(USTPMarketWidget* pWidget, USTPSubmitWidget* pSubmitWidget, const QString& inss, QWidget* parent = 0);
...
private:
	void initConnect(USTPMarketWidget* pWidget, USTPSubmitWidget* pSubmitWidget);
